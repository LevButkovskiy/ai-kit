...
Once implementation starts, tick each "Done when" item in the contract file as it is
verified. The contract is the working checklist — a fresh session must be able to read
it and see what is already done.
